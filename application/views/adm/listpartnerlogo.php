                                ...
                                <div id="grid-layout-table-1" class="box jplist">
                                    ...
                                    <div class="box text-shadow">
                                        <table class="demo-tbl"><!--<item>1</item>-->
                                            ...
                                            <td class="img" style="width: 220px;">

                                                    <?php if ($customer->logo != "") { ?>
                                                    <img src="/img_partner_slide/<?php echo $customer->logo; ?>" alt="" title="" style="width: 120px; height: 120px;" /></a>&nbsp;
                                                    <?php } else { ?>
                                                    <img src="/img_partner_slide/no_image.jpg" alt="" title="" style="width: 120px; height: 120px;" />&nbsp;
                                                    <?php } ?>
                                            </td>
                                            <!--<data></data>-->
                                            <td class="td-block" >
                                            ...
                                            <td style="width: 220px;">
                                               ...
                                               <?php if ($customer->is_published) { ?>
                                                    <a href="/adm/publishpartnerslide/<?php echo $customer->id; ?>"><button type="button" class="btn btn-warning">Unpublish</button></a>
                                                <?php } else { ?>
                                                    <a href="/adm/publishpartnerslide/<?php echo $customer->id; ?>"><button type="button" class="btn btn-info">Publish</button></a>
                                                <?php } ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/adm/delpartnerslide/<?php echo $customer->id; ?>"><button type="button" class="btn btn-danger">Confirm</button></a>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
